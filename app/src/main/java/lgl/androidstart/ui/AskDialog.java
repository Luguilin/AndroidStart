...
public class AskDialog extends Dialog {
	...
	public onDismissListen getDismissListen() {
		return dismissListen;
	}

	public void setDismissListen(onDismissListen dismissListen) {
	...
	public void postDismiss(long time) {
		CountDownTimer downTimer = new CountDownTimer(time, time) {
	...
	public static class Builder {
		...
		public AskDialog create() {
			...
			final AskDialog dialog = new AskDialog(context, R.style.Dialog);
